<template>
  <div class="flex flex-col gap-4">
    <label class="font-semibold text-gray-700 text-sm mb-1">Profile Picture</label>
    
    <!-- Current Image Display -->
    <div v-if="imageUrl" class="flex items-center gap-4">
      <img 
        :src="imageUrl" 
    ...
    <div class="flex flex-col sm:flex-row gap-3">
      ...
      <button
        ...
        type="button"
        class="flex items-center justify-center gap-2 px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors"
      >
